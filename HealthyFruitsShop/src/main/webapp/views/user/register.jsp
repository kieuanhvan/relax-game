					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="signin-container">
							 <form:form action="register.php" name="frm-login" method="post" modelAttribute = "register">
								...
								<!-- <p class="form-row">
									<label for="fid-pass">Code:<span class="requite">*</span></label>
									<input type="text" id="fid-pass" name="code" value=""
										class="txt-input">
								</p> -->
								
								 <p class="form-row">
									<label for="fid-pass">My Photo:<span class="requite">*</span></label>
									<form:input type="file" id="fid-pass" path="photo" value=""
										class="txt-input"></form:input>
