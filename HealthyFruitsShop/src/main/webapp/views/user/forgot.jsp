    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><span class="current-page">Forgot</span></li>
            </ul>
        </nav>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="signin-container">
                            <form action="forgot.php" name="frm-login" method="post">
                                <p class="form-row">
                                ...
                                <p class="form-row wrap-btn">
                                    <button class="btn btn-submit btn-bold" type="submit">Send</button>
