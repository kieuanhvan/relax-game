                ...
                <div class="sumary-product single-layout">
                    <div class="media">
                        <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/p01.jpg" alt="" width="500" height="500"></li>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/p02.jpg" alt="" width="500" height="500"></li>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/p03.jpg" alt="" width="500" height="500"></li>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/p06.jpg" alt="" width="500" height="500"></li>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/p07.jpg" alt="" width="500" height="500"></li>
                        </ul>
                        <ul class="biolife-carousel slider-nav" data-slick='{"arrows":false,"dots":false,"centerMode":false,"focusOnSelect":true,"slidesMargin":10,"slidesToShow":4,"slidesToScroll":1,"asNavFor":".slider-for"}'>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/thumb_p01.jpg" alt="" width="88" height="88"></li>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/thumb_p02.jpg" alt="" width="88" height="88"></li>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/thumb_p03.jpg" alt="" width="88" height="88"></li>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/thumb_p06.jpg" alt="" width="88" height="88"></li>
                            <li><img src="${pageContext.request.contextPath}/templates/assets/images/details-product/thumb_p07.jpg" alt="" width="88" height="88"></li>
                        </ul>
                    </div>
                    ...
                    <div class="action-form">
                        ...
                        <div class="acepted-payment-methods">
                            <ul class="payment-methods">
                                <li><img src="${pageContext.request.contextPath}/templates/assets/images/card1.jpg" alt="" width="51" height="36"></li>
                                <li><img src="${pageContext.request.contextPath}/templates/assets/images/card2.jpg" alt="" width="51" height="36"></li>
                                <li><img src="${pageContext.request.contextPath}/templates/assets/images/card3.jpg" alt="" width="51" height="36"></li>
                                <li><img src="${pageContext.request.contextPath}/templates/assets/images/card4.jpg" alt="" width="51" height="36"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":5, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}]}'>
                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="#" class="link-to-product">
                                        <img src="${pageContext.request.contextPath}/templates/assets/images/products/p-15.jpg" alt="dd" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories">Fresh Fruit</b>
                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="#" class="link-to-product">
                                        <img src="${pageContext.request.contextPath}/templates/assets/images/products/p-21.jpg" alt="dd" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories">Fresh Fruit</b>
                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="#" class="link-to-product">
                                        <img src="${pageContext.request.contextPath}/templates/assets/images/products/p-18.jpg" alt="dd" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories">Fresh Fruit</b>
